...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  1 12:41:38 2021
...
def train(seed, TrainingSet_Array, Labels_Array, nTraj):
    #seed
    List_TimeBatch = []
    List_RewardBatch = []
    List_STDBatch = []
...
pool = MyPool(10)
args = [(seed, TrainingSet_Array, Labels_Array, nTraj) for seed in range(10)]
