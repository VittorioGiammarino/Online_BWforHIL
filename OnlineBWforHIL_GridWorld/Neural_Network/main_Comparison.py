...
plt.xticks(Samples, labels=['100', '200', '500', '1k', '2k'])
clrs = sns.color_palette("husl", 5)
ax.plot(Samples, List_RewardOnline[0:size], label='Online-BW', c=clrs[0])
ax.fill_between(Samples, List_RewardOnline[0:size]-List_STDOnline[0:size], List_RewardOnline[0:size]+List_STDOnline[0:size], alpha=0.1, facecolor=clrs[0])
ax.plot(Samples, List_RewardBatch[0:size], label = 'Batch-BW', c=clrs[1])
ax.fill_between(Samples, List_RewardBatch[0:size]-List_STDBatch[0:size], List_RewardBatch[0:size]+List_STDBatch[0:size], alpha=0.1, facecolor=clrs[1])
ax.plot(Samples, Reward_Expert*np.ones(len(nTraj)), label='Expert', c=clrs[2])
#ax.fill_between(Samples, Reward_Expert*np.ones(len(nTraj))-STDExpert, Reward_Expert+STDExpert, alpha=0.1, facecolor=clrs[2])
ax.legend(loc=4, facecolor = '#d8dcd6')
ax.set_xlabel('Training Samples')
ax.set_ylabel('Average Reward')
ax.set_title('Grid World')
plt.savefig('Figures/Comparison/Reward_GridWorld_NN_2.png', format='png')
...
ax.set_ylabel('Average Reward')
ax.set_title('Grid World')
plt.savefig('Figures/Comparison/Reward_GridWorld_NN_3_scaled.png', format='png')
