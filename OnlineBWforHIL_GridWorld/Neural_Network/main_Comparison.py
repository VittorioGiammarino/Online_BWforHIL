...
# with open('Comparison/Batch/List_RewardBatch.npy', 'rb') as f:
#     List_RewardBatch = np.load(f)

# with open('Comparison/Batch/List_STDBatch.npy', 'rb') as f:
#     List_STDBatch = np.load(f)
    
# with open('Comparison/Batch/List_LikelihoodBatch.npy', 'rb') as f:
#     List_LikelihoodBatch = np.load(f)
    
# with open('Comparison/Batch/List_TimeLikelihood.npy', 'rb') as f: # remember to change in TimeLikelihoodBatch
#     List_TimeLikelihoodBatch = np.load(f)
    
# with open('Comparison/Online/List_TimeOnline.npy', 'rb') as f:
#     List_TimeOnline = np.load(f)
    
# with open('Comparison/Online/List_RewardOnline.npy', 'rb') as f:
#     List_RewardOnline = np.load(f)
    
# with open('Comparison/Online/List_STDOnline.npy', 'rb') as f:
#     List_STDOnline = np.load(f)
    
# with open('Comparison/Online/List_LikelihoodOnline.npy', 'rb') as f:
#     List_LikelihoodOnline = np.load(f, allow_pickle=True).tolist() 
    
# with open('Comparison/Online/List_TimeLikelihoodOnline.npy', 'rb') as f:
#     List_TimeLikelihoodOnline = np.load(f, allow_pickle=True).tolist() 
...
for i in range(len(nTraj)):
    ...
    TerminationExpert, psiExpert, rewardExpert] = ExpertSim.HierarchicalStochasticSampleTrajMDP(max_epoch, nTraj[i], seed)
